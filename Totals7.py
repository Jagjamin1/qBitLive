...
while True:
    ...
    print(tabulate.tabulate([[format_bytes(totalsize), format_bytes(remaining), format_bytes(AveSpeed), format_timespan(eta/tc)]], headers=["Total Size", "Remaining", "Average DL Speed", "Average ETA"], tablefmt="orgtbl"))
